...
function Lender() {
  ...
  const handleTenantClick = () => {
    navigate('/'); // Navigate to the Tenant page
  };
        ...
        <main className="grow">
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto ">
            ...
            <div className="grid grid-cols-3 grid-rows-2 gap-3">
                ...
                {/* <!-- b: Row 1, Column 2 --> */}
                <div className="bg-gray-400 shadow-no-shadow hover:shadow-hover-white transition-shadow duration-300 rounded-xl"><DashboardCard02 /></div>
